...
class Controller:
    ...
    def load_configurations(self):
        ...
        configuration_template = {
                #TODO - make num.partitions dynamic in configuration
                "num.partitions": 10, "number_of_brokers": 3, "message_size_kb": 7500, "max_producers": 5,
                "producer_increment_interval_sec": 60, "machine_size": "n1-standard-1", "disk_size": 100,
